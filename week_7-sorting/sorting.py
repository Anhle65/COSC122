...
def selection_sort(file_name):
    ...
    for fill_slot in range(len(alist) -1, 0, -1):
        ...
        for location in range(1, fill_slot +1):
            n_comps += 1        #count the comparisons
...
def gap_insertion_sort(alist, start, gap):
    ...
    for i in range (start +gap, len(alist), gap):
        ...
        while position >= gap and not (stop):
            n_comp += 1         #count the comparisons
...
def shell_sort(file_name):
    ...
    while gap > 0:
        ...
        for start_position in range(gap):
            total_comparisons += gap_insertion_sort(alist, start_position, gap)     #count the comparisons made
        gap = gap // 2
...
# print(shell_sort([7, 8, 5, 9, 4, 6]))
print(shell_sort2("file6.txt",[97, 16, 2, 1]))